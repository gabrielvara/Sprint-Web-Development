...
## Descrição
O atual site foi desenvolvido como entrega para o Sprint da matéria de Web-Development, durante a criação utilizando JavaScript, foram implicadas diversas funcionalidades que foram orientadas, como: Manipulação dinâmica de elementos e eventos das páginas; Validação de formulários e login; Alertas e prompts; Manipulação de imagens (slide show); Criação e gerenciamento de eventos de usuário com o DOM (ex.: botão).
...
- Sistema para adquirir pontos por convite e assistindo a Formula E
